...
def detect_event(data_plot, threshold = 100):

    test_stat = np.max(data_plot) - np.min(data_plot)
    is_event = (test_stat > threshold) # Test threshold
...
#     data_temp = process_data(data)
#     classified_event=three_pronged_smoothing_classifier(data_temp,samprate)
